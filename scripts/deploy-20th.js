...
async function main() {
    ...
    console.log('\n🚀 Deploying the 20th NFT collection...\n');
    console.log(`Deployer address: ${address}`);
    console.log(`Starting nonce: ${nonce}\n`);

    const result = await deployContract('deadfellaz', 'contracts/deadfellaz.clar', nonce);

    if (result) {
        console.log(`\n🎉 SUCCESS! All 20 NFT contracts have been deployed!\n`);
    }
}
